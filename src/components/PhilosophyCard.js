...
const PhilosophyCard = () => {
  return (
    <div className=' rounded-sm bg-white w-[100%]'>
      ...
      <h1 className='text-center font-extrabold text-[#fc3792] max-[1280px]:text-[60px]  md:text-[60px] text-[70px]'> $63.4 MILLION</h1>
      </div>
      {/* end of */}
      ...
      <h1 className='text-start font-bold text-[#fc3792] max-[1100px]:text-[50px] max-[1280px]:text-[50px]  text-[62px] '> 57</h1>
      </div>
      </div>
      ...
      <h3 className='text-start font-bold max-[1100px]:text-[20px] max-[1300px]:text-[20px] text-white text-[20px] '> TOTAL AD SO END</h3>
      <h1 className='text-start font-bold max-[1100px]:text-[50px]  text-[#fc3792] max-[1280px]:text-[50px]   text-[62px] '> 147M</h1>
      </div>
      </div>
      ...
      <h1 className='text-start font-bold text-[#fc3792] max-[1100px]:text-[50px] max-[1280px]:text-[50px] text-[62px] '> 1</h1>
      </div>
      </div>
